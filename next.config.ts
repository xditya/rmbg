 ...
 * and spawn thread workers; nothing else.
 */
const WORKER_CSP = ["default-src 'none'", "script-src 'self' blob: 'wasm-unsafe-eval'", "connect-src 'self' blob: https://staticimgly.com", "worker-src 'self' blob:"].join("; ");
